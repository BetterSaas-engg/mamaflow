...
// Release signing (tester distribution). Reads android/key.properties — a
// gitignored local file pointing at the developer-held upload keystore.
// Absent (CI, fresh clones), release builds fall back to debug signing so
    ...
    buildTypes {
        release {
            signingConfig = if (keystorePropertiesFile.exists()) {
                ...
                // No local keystore (CI/fresh clone): debug-sign so
                // `flutter run --release` still works. Never distribute these.
